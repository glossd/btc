...
func main() {
	...
	rawTx, err := txutil.Create(txutil.CreateParams{
		PrivateKey:  "your-wif", // e.g. 932u6Q4xEC9UYRb3rS2BWrSpSPEt5KaU8NNP7EWy7zSkWmfBiGe
		Destination: "address",  // e.g. n4kkk9H2jGj7t8LA4vxK4DHM7Lq95VaEXC
		Amount:      500000,     // satoshi to send
		Net:         net,
		Compressed:  false, // format of your WIF and Bitcoin addresses
	})
	if err != nil {
		panic(err)
	}
	...
	if err != nil {
		fmt.Errorf("couldn't broadcast raw tx")
		panic(err)
	}
